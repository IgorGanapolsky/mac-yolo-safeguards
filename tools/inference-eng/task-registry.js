...
const TASKS = Object.freeze([
  ...
  },
  {
    ...
    concurrency: 'interactive',
    modelClass: 'frontier',
    preferredModels: ['grok-4.5', 'glm-coding', 'kimi-code', 'deepseek-v4-flash'],
  ...
  },
  {
    ...
    concurrency: 'interactive',
    modelClass: 'coding',
    preferredModels: ['grok-4.5', 'glm-coding', 'kimi-code', 'deepseek-v4-flash', 'hermes-local'],
  ...
  },
  {
    ...
    concurrency: 'steady',
    modelClass: 'fast',
    preferredModels: ['kimi-code-fast', 'deepseek-v4-flash-free', 'hermes-local-fast', 'glm-coding'],
  ...
  },
  {
    ...
    concurrency: 'batch',
    modelClass: 'coding',
    preferredModels: ['deepseek-v4-flash', 'glm-coding', 'kimi-code', 'grok-4.5'],
