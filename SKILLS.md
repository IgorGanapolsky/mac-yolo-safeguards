...
| `search-as-code-fleet` | Perplexity Search-as-Code across every agent/harness: generate a retrieval program (fanout, filter, dedupe, BM25+RRF, verify, compact) instead of serial web_search/MCP dumps. Health: `bin/sac-fleet doctor --json`. | `.agents/skills/search-as-code-fleet/SKILL.md` | local |
