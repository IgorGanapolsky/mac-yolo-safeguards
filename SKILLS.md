...
| `seedance-video-suite` | BytePlus Seedance 2.5 via seed-yolo: official 30s Broadway prompt, 50-ref cap, precision revise, STAGE_ONLY under $10/mo. | `~/workspace/git/igor/mac-yolo-safeguards/.agents/skills/seedance-video-suite/SKILL.md` | local |
