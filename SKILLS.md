...
| `gurobi-harness-gate` | Session/process gate + Phase One frozen acceptance bench (OPTIMAL/IIS/UNBOUNDED certificates). Proof, not guesses. Slash: /gurobi-harness-gate. | `.agents/skills/gurobi-harness-gate/SKILL.md` | local |
