...
| `gurobi-harness-gate` | Session/process gate: Gurobi certifies $10 token-budget + exclusive adb/git_lock dispatch at session-start. Proof, not guesses. Slash: /gurobi-harness-gate. | `.agents/skills/gurobi-harness-gate/SKILL.md` | local |
