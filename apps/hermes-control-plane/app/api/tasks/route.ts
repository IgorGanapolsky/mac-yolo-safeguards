...
export async function POST(request: Request) {
  ...
  // Continuity-only runs use null deviceId if no machine is paired yet.
  if (!device && route !== "cloud") return jsonError("pair a Hermes machine before starting work", 409);
