...
export async function collectExpertiseData(): Promise<ExpertiseData> {
  ...
  return {
    ...
    caseStudies: [
      {
        id: "cs-001",
        title: "Autonomous coding agent completes 14-hour PR refactor without session interruption",
        orgType: "solo",
        challenge: "Running long-horizon autonomous agents on local machines risks network drops, sleeping laptops, and power resets mid-task, causing context loss.",
        solution: "Dispatched task to ThumbGate Cloud VPS Continuity runner ($10/mo). Agent executed autonomously within a fenced 90s renewable lease under LLM-as-a-Judge guardrails.",
        outcome: "Zero lost agent-hours across complex long-horizon sessions. 147 cloud continuations in 60 days, 99.3% success rate.",
      ...
      {
        id: "cs-002",
        title: "Multi-agent team runs parallel overnight verification pipelines",
        orgType: "team",
        challenge: "Local hardware bottlenecks and sequential execution stall engineering velocity when running concurrent test and research agents.",
        solution: "Enabled ThumbGate Team Continuity. Multiple agents dispatch to dedicated cloud VPS runners with isolated sandbox environments.",
        outcome: "3x parallel agent throughput overnight. Team ships features 40% faster per sprint without local hardware lockup.",
