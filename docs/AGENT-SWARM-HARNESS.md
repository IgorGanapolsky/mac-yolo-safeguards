...
| `node tools/governed-data-mesh.js cash-truth\|live-matrix\|…` | Billing-first cash truth, campaign watermarks, durable outbound ledger |
...
15. **Governed data mesh (InfoQ July 2026)** — billing-first `cash_truth`, semantic LIVE matrix, Monzo-style interface validation, DBOS-style outbound unique keys, micro-batch campaign watermarks, high-stakes eval rules. Source: InfoQ Software Architects' Newsletter July 2026 (“Building Data Platforms”). CLI: `data-mesh` + `tools/governed-data-mesh.js`.
