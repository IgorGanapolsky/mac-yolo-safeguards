...
- 2026-07-30: **never leave `<<<<<<<` in AGENTS.md/plan.md** — PR #1191 class; `node tools/check-merge-conflict-markers.js` + doctor critical.
- 2026-07-30: mega-prompt **unexpected EOF / Error code 500 / turn time limit** → Start fresh (not 6m thinking); eval ability `mega_prompt_provider_eof`; self-harness pattern `model_provider_unexpected_eof`.
