...
node --check tools/hermes-provider-routing-audit.js
node --check tools/hermes-curator-value-audit.js
...
node --check tests/test-hermes-provider-routing-audit.js
node --check tests/test-hermes-curator-value-audit.js
...
node tests/test-hermes-provider-routing-audit.js
node tests/test-hermes-curator-value-audit.js
