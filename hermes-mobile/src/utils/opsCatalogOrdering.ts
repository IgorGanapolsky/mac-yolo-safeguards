...
/** Alphabetical copy for nested tool names; never mutate gateway response arrays. */
export function sortCatalogNamesAlphabetically(names: readonly string[]): string[] {
  return [...names].sort(compareCaseInsensitive);
}
