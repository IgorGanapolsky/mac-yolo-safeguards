...
| Console experiment | ✅ **In progress** `7582167718598236328` — “Short desc A vs hybrid C”, 50% audience, variant A classic short; Publishing overview Changes in review |
| Metric | Retained first-time installers |
