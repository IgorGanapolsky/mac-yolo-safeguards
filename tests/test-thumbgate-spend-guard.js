...
const allowCases = [
  ...
  ['Bash', { command: 'git switch feat/my-branch' }],
  ['Bash', { command: 'git commit -m "fix(gate): satisfy_gate unwedge"' }],
  ['satisfy_gate', { gate_id: 'gate-1' }],
  ['mcp__thumbgate__satisfy_gate', { gate_id: 'gate-1' }],
  ['approve_protected_action', { action_id: 'action-1' }],
