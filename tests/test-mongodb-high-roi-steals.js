...
// 1. Test Atlas Vector Search Vault
...
assert(searchResults[0].score > 0.8, 'Expected high hybrid relevance score');
console.log('  ✓ Hybrid Vector + Keyword RAG search returned top relevant document with score ' + searchResults[0].score);

// 2. Test Change Stream Notifier
...
console.log('  ✓ Change Stream reactive notification listener fired cleanly on state update.');
